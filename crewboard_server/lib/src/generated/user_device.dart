...
class UserDeviceUpdateTable extends _i1.UpdateTable<UserDeviceTable> {
  ...
  _i1.ColumnValue<String, String> hardwareId(String value) => _i1.ColumnValue(
    table.hardwareId,
    value,
  );

  _i1.ColumnValue<String, String> socketId(String? value) => _i1.ColumnValue(
    table.socketId,
    value,
  );
}
...
class UserDeviceTable extends _i1.Table<_i1.UuidValue?> {
  UserDeviceTable({super.tableRelation}) : super(tableName: 'user_devices') {
    ...
    hardwareId = _i1.ColumnString(
      'hardwareId',
      this,
    );
    socketId = _i1.ColumnString(
      'socketId',
      this,
    );
  }
  ...
  late final _i1.ColumnEnum<_i3.DeviceType> deviceType;

  late final _i1.ColumnString hardwareId;

  late final _i1.ColumnString socketId;
