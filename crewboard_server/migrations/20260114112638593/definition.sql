...
--
-- Class PlannerThreadReadStatus as table planner_thread_read_status
--
...
--
-- Foreign relations for "planner_activities" table
--
...
--
-- Foreign relations for "planner_thread_read_status" table
--
