...
--
-- Class FontSetting as table font_setting
--
...
--
-- Class PlannerActivity as table planner_activities
--
...
CREATE TABLE "system_variables" (
    ...
    "flowLineHeight" double precision,
...
--
-- Class TicketView as table ticket_views
--
...
--
-- Class Memory as table user_memory_map
--
CREATE TABLE "user_memory_map" (
    "id" bigserial PRIMARY KEY,
    "userId" uuid NOT NULL,
    "title" text NOT NULL,
    "body" text NOT NULL,
...
--
-- Foreign relations for "ticket_views" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('crewboard', '20260122041945935', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260122041945935', "timestamp" = now();
