...
CREATE TABLE "system_variables" (
    ...
    "allowDelete" boolean,
    "showDelete" boolean,
    "fontSizeBody" double precision,
    "fontSizeTitle" double precision,
    "fontSizeHeading1" double precision,
    "fontSizeHeading2" double precision,
    "fontSizeHeading3" double precision,
    "fontFamily" text
);
