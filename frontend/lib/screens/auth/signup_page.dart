...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> _checkOrganizationName(String name) async {
    ...
    try {
      final response = await server.auth.checkOrganization(
        CheckOrganizationParams(name: name),
      );
      setState(() {
  ...
  Future<void> _registerUser() async {
    ...
    try {
      ...
      final params = RegisterAdminParams(
        ...
        organizationName: _signupType == 'organization'
            ? _organizationNameController.text.trim()
            : null,
        organizationId: _signupType == 'self-hosting' ? _organizationId : null,
      );

      final response = await server.auth.signupAdmin(params);

      if (response.success ||
          (response.message == 'Username already exists' ||
              response.message == 'Email already exists' ||
              response.message == 'User already exists')) {
        // Persist userId to local storage if provided
  ...
  // removed social sign-in methods per requirement
              ...
              children: [
                Expanded(
                  child: RadioListTile<String>(
                    title: const Text('Organization',style: TextStyle(fontSize: 14)),
                    value: 'organization',
                ...
                Expanded(
                  child: RadioListTile<String>(
                    title: const Text('Self Hosting',style: TextStyle(fontSize: 14)),
                    value: 'self-hosting',
                    groupValue: _signupType,
                    onChanged: (value) {
                      setState(() {
            ...
            if (_signupType == 'organization') ...[
              ...
              AuthInputField(
                ...
                suffixIcon: _isCheckingOrganization
                    ...
                    : _organizationNameController.text.isNotEmpty && !_isCheckingOrganization
                        ? Icon(
