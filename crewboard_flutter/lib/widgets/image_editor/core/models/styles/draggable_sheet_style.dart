...
class DraggableSheetStyle {
  ...
  /// Creates a copy of this `DraggableSheetStyle` object with the given fields
  /// replaced with new values.
  ///
  /// The [copyWith] method allows you to create a new instance of
  /// [DraggableSheetStyle] with some properties updated while keeping the
  /// others unchanged.
  DraggableSheetStyle copyWith({
