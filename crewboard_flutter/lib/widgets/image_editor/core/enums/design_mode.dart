...
/// elements used in an image editor.
///
/// - `material`: Represents the Material Design style, which is a modern
/// design language developed by Google. It typically includes bold colors and
/// shadows.
/// - `cupertino`: Represents the Cupertino Design style, which is Apple's
/// design language known for its clean and minimalistic appearance with rounded
/// elements.
///
/// Example Usage:
/// ```dart
