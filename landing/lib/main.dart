...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    Window.stageWidth = Window.isMobile
        ? Window.width
        : Window.width - Window.sideBarWidth;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(children: [ParalaxBlock(child: Intro())]),
      ),
    );
  }
}
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          Column(children: [Intro(), ChatDemo(), FlowieDemo(), PlannerDemo()]),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Row(
        children: [
          SizedBox(width: 10),
          Image.asset(width: 35, "assets/logo.png"),
          SizedBox(width: 5),
          Text(
            "Crewboard",
