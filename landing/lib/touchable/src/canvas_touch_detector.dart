  ...
  Widget build(BuildContext context) {
    return TouchDetectionController(
      ...
      child: GestureDetector(
        ...
        onVerticalDragDown:
            !widget.gesturesToOverride.contains(GestureType.onVerticalDragDown)
            ? null
            : (tapDetail) {
                touchController.add(
        ...
        onVerticalDragStart:
            !widget.gesturesToOverride.contains(GestureType.onVerticalDragStart)
            ? null
            : (tapDetail) {
                touchController.add(
        ...
        onForcePressUpdate:
            !widget.gesturesToOverride.contains(GestureType.onForcePressUpdate)
            ? null
            : (tapDetail) {
                touchController.add(
        ...
        //       },
        onSecondaryTapDown:
            !widget.gesturesToOverride.contains(GestureType.onSecondaryTapDown)
            ? null
            : (tapDetail) {
                touchController.add(
